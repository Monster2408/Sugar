...
LOG_NAME_DICT = {
    discord.Locale.american_english: 'Channel Create Log',
    discord.Locale.japanese: 'チャンネル作成ログ',
}

class ChannelCreateEventCog(commands.Cog):
    ...
    async def on_ready(self):
        print('load event cog: ChannelCreateEventCog')
...
async def setup(bot: commands.Bot):
    await bot.add_cog(ChannelCreateEventCog(bot))